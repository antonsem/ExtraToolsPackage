...
namespace ExtraTools
{
	public static class Utils
	{
		...
		private const string MATERIAL_INDEX_WARNING =
			"Renderer {0} has {1} materials. You are trying to access {2}. material.";
		...
		public static void SetProperty(this Renderer renderer, int propertyHash, int value, int materialIndex = 0)
		{
			...
			{
				Debug.LogWarning(MATERIAL_INDEX_WARNING.Format(renderer.name, renderer.materials.Length.ToString(),
